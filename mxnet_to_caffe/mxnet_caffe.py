...
parser.add_argument('--mx-model', type=str, default='./r50_model/model')
parser.add_argument('--mx-epoch', type=int, default=11)
parser.add_argument('--cf-prototxt', type=str, default='./r50_model/face.prototxt')
parser.add_argument('--cf-model', type=str, default='./r50_model/face.caffemodel')
